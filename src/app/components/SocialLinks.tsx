...
export const SocialLinks = () => {
  return (
    <div className="fixed left-8 bottom-0 flex flex-col items-center space-y-6 text-lg text-lightSlate">
      <a href="https://github.com" target="_blank" className="hover:text-green"><FaGithub /></a>
      ...
      <a href="https://linkedin.com" target="_blank" className="hover:text-green"><FaLinkedin /></a>
