        ...
        >
            ...
            <div>
                ...
                <div className="space-y-4 text-lightSlate font-sans text-xl leading-[1.3]">
                    <p>
                        Hello! My name is <span className="text-lightestSlate">Pradeesh</span> and I enjoy
                        creating things that live on the internet. My interest in web development started back
                        in 2012 when I decided to try editing custom Tumblr themes — turns out hacking together
                        a custom reblog button taught me a lot about HTML & CSS!
                    </p>
                    <p>
                        Fast-forward to today, and I've had the privilege of working at{" "}
                        <span className="text-green">an advertising agency</span>,{" "}
                        <span className="text-green">a start-up</span>,{" "}
                        <span className="text-green">a huge corporation</span>, and{" "}
                        <span className="text-green">a student-led design studio</span>. My main focus these
                ...
                {/* Tech List */}
                <ul className="grid grid-cols-2 gap-2 mt-6 text-sm font-mono text-slate">
            ...
            <div className="relative max-w-xs mx-auto">
                <div className="relative group">
                    ...
                    <img
                        ...
                        alt="Profile"
                        className="rounded-md filter grayscale contrast-100 brightness-90 group-hover:grayscale-0 transition duration-300"
                    />

                    {/* Overlay */}
                    <div className="absolute inset-0 bg-green/20 rounded-md mix-blend-multiply group-hover:bg-transparent transition duration-300"></div>

                    {/* Border effect */}
                    <div className="absolute -inset-2 border-2 border-green rounded-md translate-x-2 translate-y-2 group-hover:translate-x-3 group-hover:translate-y-3 transition-all duration-300"></div>
                </div>
            </div>
        </section>
    );
